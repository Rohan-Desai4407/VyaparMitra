...
const replacements = [
    { from: /bg-white/g, to: 'bg-white dark:bg-gray-800' },
...
// Special fixes for inputs and selects that might need background in dark mode if they had none implicitly
// Add dark:bg-gray-700 to inputs
